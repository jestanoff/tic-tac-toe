...
describe('<Space />', () => {
  test('should render a top space', () => {
    const { asFragment } = render(<Space id={0} handleSpaceClick={() => {}} />);
  ...
  test('should render top left empty space', () => {
    render(<Space id={0} handleSpaceClick={() => {}} />);
  ...
  test('should render top left marked by cross space', () => {
    render(<Space id={0} handleSpaceClick={() => {}} status={1} />);
  ...
  test('should render top left marked by circle space', () => {
    render(<Space id={0} handleSpaceClick={() => {}} status={2} />);
  ...
  test('should render top center empty space', () => {
    render(<Space id={1} handleSpaceClick={() => {}} />);
  ...
  test('should render top center marked by cross space', () => {
    render(<Space id={1} handleSpaceClick={() => {}} status={1} />);
  ...
  test('should render top center marked by circle space', () => {
    render(<Space id={1} handleSpaceClick={() => {}} status={2} />);
    expect(screen.getByRole('button', { name: /^Top center space marked by circle$/i })).toHaveClass('space top center');
  });

  test('should render top right empty space', () => {
    render(<Space id={2} handleSpaceClick={() => {}} />);
  ...
  test('should render top right marked by cross space', () => {
    render(<Space id={2} handleSpaceClick={() => {}} status={1} />);
  ...
  test('should render top right marked by circle space', () => {
    render(<Space id={2} handleSpaceClick={() => {}} status={2} />);
  ...
  test('should render left middle empty space', () => {
    render(<Space id={3} handleSpaceClick={() => {}} />);
  ...
  test('should render left middle marked by cross space', () => {
    render(<Space id={3} handleSpaceClick={() => {}} status={1} />);
    expect(screen.getByRole('button', { name: /^Left middle space marked by cross$/i })).toHaveClass('space left middle');
  });

  test('should render left middle marked by circle space', () => {
    render(<Space id={3} handleSpaceClick={() => {}} status={2} />);
    expect(screen.getByRole('button', { name: /^Left middle space marked by circle$/i })).toHaveClass('space left middle');
  });

  test('should render center middle empty space', () => {
    render(<Space id={4} handleSpaceClick={() => {}} />);
  ...
  test('should render center middle marked by cross space', () => {
    render(<Space id={4} handleSpaceClick={() => {}} status={1} />);
    expect(screen.getByRole('button', { name: /^Center middle space marked by cross$/i })).toHaveClass('space center middle');
  });

  test('should render center middle marked by circle space', () => {
    render(<Space id={4} handleSpaceClick={() => {}} status={2} />);
    expect(screen.getByRole('button', { name: /^Center middle space marked by circle$/i })).toHaveClass('space center middle');
  });
